...
If Request.Form("Submit") = "Submit" Then
	rsApplicant.Open "Application_MOTF1", cnnMain,3,3
	rsApplicant.AddNew
...
' Send e-mail notification to BCFPD 
		...
		servBody = "A MO-TF1 Join Application has been submitted." & vbCrLf & vbCrLf & "This information is available on the website at:" & vbCrLf & vbCrLf & "http://www.bcfdmo.com/members_only/index.asp?Login=True" & vbCrLf & vbCrLf & "Received:" & now() & vbCrLf
		...
		servMess.FromName = Request.Form("First_Namereq") & " " & Request.form("Last_Namereq")
		servMess.From = Request.Form("Email")
		servMess.Subject = "BCFPD Web Site - MO-TF1 Join Application"
			...
			<form method="post" action="index.asp" id="form1" name="form1" onsubmit="return ValidateApp(document.form1.elements, 'You must enter a ');">
		      <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#f2f2f2">
				...
				<tr>
					...
					<td class="AppLabel"><input type="text" name="DLN" size="11" maxlength="11">
					&nbsp;&nbsp;&nbsp;State:
					&nbsp;&nbsp;&nbsp;<input type="text" name="DL_State" size="2" maxlength="2">
					&nbsp;&nbsp;&nbsp;Date of Expiration:
					&nbsp;&nbsp;&nbsp;<input type="text" name="DL_Exp" size="8" maxlength="25"></td>
				</tr>
				<tr>
