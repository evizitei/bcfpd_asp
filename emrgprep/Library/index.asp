...
<!--#include virtual="/include/menus/emergency_preparedness.asa"-->
<%
	set rsCategory = Server.CreateObject("ADODB.Recordset")
	strCategory = "SELECT * FROM emerg_prep_library_category ORDER BY Name ASC"
...
<table cellpadding="5" cellspacing="0" border="0" width="98%">
	<tr>
		<td class="PageTitle">Emergency Preparedness Library</td>
	</tr>	
	<tr>
		<td>
					...
					<td>
						<table cellpadding="0" cellspacing="1" border="0" width="100%" >
							<tr>
								...
								<%	rsLibrary.Open "SELECT * FROM emerg_prep_Library_File WHERE Library_Category_ID = " & rsCategory("Category_ID") & " ORDER BY Name ASC", cnnMain, 3
									do while not rsLibrary.EOF %>
							<tr>
										<td valign="top"  class="ContactInfo"><a class="news" href="/emrgprep/library/files/<%=rsLibrary("Name")%>" target="_new"><%=rsLibrary("Name")%></a></td>
