...
function CreateTimeEditables(paramName, postFix, enabled, cssClass, style, hour, minute, second)
{
   ...
   // There is no way to set the width of select boxes except by manipulating the text tags associated with <option>s.
   // You can add a margin by beginning and ending your option's text with a &nbsp;.
   var editablesHtml = "";
   if (TD.displayHour)
   {
