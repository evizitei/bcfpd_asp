...
var L_FROM_BEFORE = "De {0} jusqu'avant {1}";
var L_AFTER_TO = "Apr\u00e8s {0} jusqu'a {1}";
var L_AFTER_BEFORE = "Apr\u00e8s {0} jusqu'avant {1}";
...
var L_PleaseRefresh = "Cliquez sur le bouton Actualiser, puis r\u00e9essayez";
