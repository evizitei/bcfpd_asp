	...
	<tr>
		<td align="left" valign="top" colspan="2" class="statusBox"><br>&nbsp;<br>
			<table cellpadding="3">
				<tr>
					<td>
					<font color="#330099" size="3"><strong>Video Upload was Successful</font></strong><p>
					<font size="2"><strong><%= Ucase(mySmartUpload.Files(1).FileName) %></strong></font><font size="2"> was uploaded to the<p></font>
					<font size="2"><strong><%= Path %></strong> folder<p></font>
