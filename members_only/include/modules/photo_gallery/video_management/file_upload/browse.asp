...
//File must be either a .mpg or .mpe or .mpeg to upload to server.
	function Verify() {
		...
		var ext = name.substring(number, number - 3).toUpperCase();
		var ext2 = name.substring(number, number - 4).toUpperCase();
...
<body onload="JavaScript:WindowSize();">
...
<table border="2" bordercolor="#330099" cellpadding="0" cellspacing="3" height="100%" width="100%">
	<tr>
		...
		<table cellpadding="3">
		  <tr>
		    <td>
				<font color="#330099" size="3"><b>Upload a Video</b></font>
