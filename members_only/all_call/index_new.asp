...
<!-- #include virtual="/members_only/include/common/fileupload/upload.asa" -->
...
if Request.QueryString("Delete") <> "" then
	cnnBCFPD.execute("Delete from AllCall where nID = " & killChars(Request.QueryString("Delete")))
end if
...
if Request.ServerVariables("REQUEST_METHOD") = "POST" then
	...
	For Each File In Uploader.Files.Items		
		...
		rs.Open "AllCall", cnnBCFPD, 2, 2
		rs.AddNew 
		
		rs("FileName") = File.FileName
		rs("AllCallYear") = Uploader.Form("MinutesYear")
		rs("ContentType") = File.ContentType
		File.SaveToDatabase RS("Document")
...
<table width="98%" border="0" cellspacing="0" cellpadding="5" bordercolor="orange">
	...
	<p>	
	<%set rs = cnnBCFPD.execute("select nID, AllCallYear, FileName, ContentType, DateEntered from AllCall order by nID Desc")%>
